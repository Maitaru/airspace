    ...
    <main className="flex flex-col relative">
        <div className="bg-main relative main-h-[65vh] h-[70vh] px-4">
            ...
            <div className="relative py-10 container mx-auto text-white flex flex-col gap-2">
                ...
                <p className="text-base md:text-lg">We are always online and actively waiting for message</p>
            </div>
        </div>
        <div className="relative px-4 -mt-10 mb-20 z-20">
            <form className="bg-white mx-auto shad p-5 rounded-lg grid md:grid-cols-2 w-full max-w-screen-md gap-3 md:gap-5">
                <div className="flex items-center gap-4 md:col-span-2">
                  ...
                  <input type="text" placeholder='FirstName' required className="rounded-md border-2 border-slate-200 py-2 px-4 text-sm md:text-base outline-none hover:border-main" /><input type="text" placeholder='LastName' required className="rounded-md border-2 border-slate-200 py-2 px-4 text-sm md:text-base outline-none hover:border-main" /><input type="email" placeholder='Example@gmail.com' required className="rounded-md border-2 border-slate-200 py-2 px-4 text-sm md:text-base outline-none hover:border-main" /><div required className="rounded-md border-2 border-slate-200 py-2 px-4 text-sm md:text-base outline-none hover:border-main">
                    <PhoneInput
                       flags={flags}
                       defaultCountry='NG'
                       international
